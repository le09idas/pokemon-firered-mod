...
Curriculum for Pokemon FireRed modding, from easy to diabolical.

| # | Lesson | Level | Status |
|---|--------|-------|--------|
| 01 | [The Data Layer — Buff the Starters](lesson-01-data-layer.md) | Beginner | Complete |
| 02 | [Move Data — What Moves Actually Are](lesson-02-move-data.md) | Beginner | Complete |
...
| 16 | [Custom NPC Sprites](lesson-16-custom-npc-sprites.md) | Expert | Complete |
| 17 | [Flags, Vars, and Quest State](lesson-17-flags-vars-and-quest-state.md) | Advanced | In Progress |
