...
const u8 gTypeEffectiveness[336] =
{
    ...
    TYPE_FIRE, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIRE, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FIRE, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WATER, TYPE_WATER, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_ICE, TYPE_FIRE, TYPE_MUL_NO_EFFECT,
